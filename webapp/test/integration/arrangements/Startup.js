sap.ui.define([
	"sap/ui/test/Opa5",
	"ovly/fiori76/worklistplantas/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("ovly.fiori76.worklistplantas.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "ovly.fiori76.worklistplantas",
					async: true
				},
				hash: oOptions.hash,
